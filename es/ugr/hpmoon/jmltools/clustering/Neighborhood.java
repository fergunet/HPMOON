 ...
 * 
 */
public class Neighborhood implements Clusterer
{
    /**
     ...
     */
    public Neighborhood (DistanceMeasure dm)
    {
        this (3, dm);
    }
     ...
     * @param dm the distance measure
     */
    public Neighborhood (double jumpTh, DistanceMeasure dm)
    {
    	this.jumpTh = jumpTh;
    	this.dm = dm;
    }
