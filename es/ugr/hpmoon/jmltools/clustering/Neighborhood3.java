 ...
 * 
 */
public class Neighborhood3 implements Clusterer
{
    /**
     ...
     */
    public Neighborhood3 ()
    {
        this (3, new EuclideanDistance());
    }
     ...
     */
    public Neighborhood3 (DistanceMeasure dm)
    {
        this (3, dm);
    }
     ...
     * @param dm the distance measure
     */
    public Neighborhood3 (double jumpTh, DistanceMeasure dm)
    {
    	this.jumpTh = jumpTh;
    	this.dm = dm;
    }
    ...
    private double meanDistanceToKNearest (int k, Dataset dataset, Instance point)
    {
    	double d = 0;
		int nNeighbors = 0;
		Iterator<Instance> it = dataset.kNearest(k, point, this.dm).iterator();
		while (it.hasNext())
		{
