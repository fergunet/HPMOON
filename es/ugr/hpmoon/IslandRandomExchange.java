...
Modifications in method preBreedingExchangePopulation by Pablo Garcia Sanchez pablogarcia@ugr.es
*/
...
public class IslandRandomExchange extends Exchanger
    {
...
//    int mailboxCapacity;
    ...
    public static void main(String[] args) throws InterruptedException
        ...
        IslandRandomExchange ie = (IslandRandomExchange)parameters.getInstanceForParameterEq(myBase, null, IslandRandomExchange.class);
    ...
    public Population preBreedingExchangePopulation(EvolutionState state)
        ...
        if( ( state.generation >= offset ) &&
            ...
            // for each of the islands where we have to send individuals
                //MODIFICATIONS BY PABLO GARCIA
            //for( int x = 0 ; x < number_of_destination_islands ; x++ )
                int x = state.random[0].nextInt(number_of_destination_islands);
                state.output.message("SELECTED ISLAND "+x);
                try
                    {
...
class IslandExchangeServer implements Runnable
    ...
    */
    ...
    /** The found message */
    public static final String FOUND = IslandRandomExchange.FOUND;

    /** The okay message */
    public static final String OKAY = IslandRandomExchange.OKAY;

    /** The synchronize message */
    public static final String SYNC = IslandRandomExchange.SYNC;
